...
namespace TSS_SYSTEM
{
    public partial class frm_control_m : Form
    {
        ...
        private void frm_control_m_Load(object sender, EventArgs e)
        {
            ...
            tb_msg4.Text = w_dt_control.Rows[0]["msg4"].ToString();
            ...
            tb_color4.Text = w_dt_control.Rows[0]["color4"].ToString();
        }

        private void btn_touroku_Click(object sender, EventArgs e)
        {
            string w_sql;
            w_sql = "update tss_control_m set hyoujun_kousu = '" + tb_hyoujun_kousu.Text + "',msg1 = '" + tb_msg1.Text + "',msg2 = '" + tb_msg2.Text + "',msg3 = '" + tb_msg3.Text + "',msg4 = '" + tb_msg4.Text + "',color1 = '" + tb_color1.Text + "',color2 = '" + tb_color2.Text + "',color3 = '" + tb_color3.Text + "',color4 = '" + tb_color4.Text + "' where system_cd = '0101'";
