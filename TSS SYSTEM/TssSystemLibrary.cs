...
//      1       2017/11/13  ・login時にlogin_fにてサイレントエラーが発生している件について想定対応（たぶんログイン画面にて終了を選んだ際に２回login_fへの書き込みが行われていて2回目はusercdが空白）
//                          ・メニューの警告用ラベル、2行分の表示エリアを確保
//                          ・クイックメニューに勤怠入力を追加
//                          ・勤怠入力、キー違反防止のチェックを追加
//                          ・納品スケジュール、売上完了フラグを表示に追加し、売上完了の受注の納品数をグレー表示に変更
//                          ・生産スケジュールチェックをより現実的な判定に変更
//      2       2017/11/22  ・生産工程マスタに、削除機能を実装
//
//
//
//
