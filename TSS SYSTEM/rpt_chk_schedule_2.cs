...
{
    /// <summary>
    /// rpt_chk_schedule_2 の概要の説明です。
    /// </summary>
    public partial class rpt_chk_schedule_2 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void rpt_chk_schedule_2_ReportStart(object sender, EventArgs e)
        {
