...
{
    public partial class frm_seikyu_ichiran_preview : Form
    {
        ...
        public frm_seikyu_ichiran_preview()
        {
            InitializeComponent();
        }

        private void frm_seikyu_ichiran_preview_Load(object sender, EventArgs e)
        {

            rpt_seikyu_ichiran rpt = new rpt_seikyu_ichiran();
            //レポートへデータを受け渡す
