...
{
    /// <summary>
    /// rpt_chk_schedule_3 の概要の説明です。
    /// </summary>
    public partial class rpt_chk_schedule_3 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void rpt_chk_schedule_3_ReportStart(object sender, EventArgs e)
        {
