...
{
    public partial class frm_tankabetu_uriage_t_prev : Form
    {
        ...
        public frm_tankabetu_uriage_t_prev()
        {
            InitializeComponent();
        }
        ...
        private void frm_tankabetu_uriage_t_prev_Load(object sender, EventArgs e)
        {
            rpt_tankabetu_uriage_t rpt = new rpt_tankabetu_uriage_t();
            //レポートへデータを受け渡す
