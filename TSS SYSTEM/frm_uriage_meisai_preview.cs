...
{
    public partial class frm_uriage_meisai_preview : Form
    {
        ...
        public frm_uriage_meisai_preview()
        {
            InitializeComponent();
        }
        ...
        private void frm_uriage_meisai_preview_Load(object sender, EventArgs e)
        {
            rpt_uriage_meisai rpt = new rpt_uriage_meisai();
            //レポートへデータを受け渡す
